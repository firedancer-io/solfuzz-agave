use crate::{
    load_builtins, proto::{SyscallContext, SyscallEffects}, utils::{self, vm::STACK_SIZE}, InstrContext
};
use prost::Message;
use solana_bpf_loader_program::syscalls::create_program_runtime_environment_v1;
use solana_compute_budget::compute_budget::ComputeBudget;
use solana_log_collector::LogCollector;
use solana_program_runtime::{invoke_context::{BpfAllocator, EnvironmentConfig, InvokeContext, SerializedAccountMetadata}, loaded_programs::ProgramCacheForTxBatch, solana_rbpf::{ebpf::{self, MM_INPUT_START}, error::StableResult, memory_region::{MemoryMapping, MemoryRegion}, program::{BuiltinProgram, SBPFVersion}, vm::{Config, EbpfVm, ContextObject}}, sysvar_cache::SysvarCache};
use solana_sdk::{account::AccountSharedData, rent::Rent, transaction_context::{IndexOfAccount, TransactionAccount, TransactionContext}};
