use clap::Parser;
use prost::Message;
use protosol::protos::VmSerializationFixture;
...
fn exec(input: &PathBuf) -> bool {
    ...
    let fixture = VmSerializationFixture::decode(&blob[..]).unwrap();
    ...
    let effects = solfuzz_agave::vm_serialization::execute_vm_serialize(context);
